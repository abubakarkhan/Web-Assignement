<?php
    session_start();
    include_once('tools.php'); // now contains module functions
    // PHP Request Processing Code
    topPart('pumps'); /* parameter is page title */
    ?>
            <section>
                <h1>Gas Pumps</h1>
            ...
            <section class="textCenter">
                <form id="contactForm" method='post' action="https://titan.csit.rmit.edu.au/~e54061/wp/processing.php">
